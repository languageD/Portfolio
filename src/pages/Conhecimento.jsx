  ...
  return(
      ...
      <div className={styles.ConhecimentoSessao}>
        ...
        <div className={styles.conhecimentos}>
          ...
          <p className={styles.conhecimento_text}> Um ótimo apoio para o Javascript, gosto bastante de usa-la pela sua facilidade e utilidade pelo fato de ser extremamente típada.</p>
          </div>
          <div className={styles.conhecimento}>
            <h2 className={styles.conhecimentoItem}>
          <FaNodeJs/> NodeJS</h2>
